...
const SignupSection = () => (
  <section id="signup" className="bg-gradient-to-b from-[#0a3d62] to-[#0c2461] py-24 text-center">
    <div className="max-w-screen-md mx-auto px-6">
      ...
      >
        <input type="email" name="email" placeholder="Enter your email" className="w-full sm:w-auto flex-1 px-6 py-3 rounded-full border-2 border-white/10 bg-[rgba(10,61,98,0.3)] text-blue-100 placeholder-blue-100/50 focus:border-amber-400 outline-none" required />
        <button type="submit" className="bg-gradient-to-r from-amber-400 to-amber-500 text-navy-900 font-bold py-3 px-8 rounded-full shadow-lg hover:translate-y-[-2px] hover:shadow-xl transition">
          Start Revolution
        </button>
      </form>
