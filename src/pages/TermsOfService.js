...
const TermsOfService = () => (
  <main className="max-w-2xl mx-auto py-20 px-6 text-gray-900 bg-white rounded-lg shadow-xl mt-16">
    ...
    <ul className="list-disc ml-6 mb-4">
      ...
      <li>You agree not to misuse the service (e.g., sending spam, violating laws, or interfering with other users).</li>
    </ul>
    <h2 className="text-xl font-semibold mt-8 mb-2">2. Email Content & Delivery</h2>
    <ul className="list-disc ml-6 mb-4">
      <li>Our service processes, sends, and receives email on your behalf as instructed by you.</li>
      <li>You retain ownership of your email content. We claim no rights except those required to provide the service.</li>
      <li>You grant us permission to process your email for the purpose of delivering, organizing, and improving the service.</li>
    </ul>
